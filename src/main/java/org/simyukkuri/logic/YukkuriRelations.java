 ...
 * </p>
 */
public final class YukkuriRelations {
	private YukkuriRelations() {
	}
	 ...
	 */
	public static Yukkuri getYukkuriById(int bodyId) {
		return org.simyukkuri.util.YukkuriLookup.getYukkuriById(bodyId);
	}
	 ...
	 * @return インスタンス。存在しない場合はnull
	 */
	public static Yukkuri findYukkuriByObjId(int objId) {
		return org.simyukkuri.util.YukkuriLookup.findYukkuriByObjId(objId);
	}
	...
	public static boolean isParent(SocialEntity self, SocialEntity other) {
		...
		return getYukkuriById(other.getParents()[Parent.PAPA.ordinal()]) == self
				|| getYukkuriById(other.getParents()[Parent.MAMA.ordinal()]) == self;
	}
	...
	public static boolean isMother(SocialEntity self, SocialEntity other) {
		...
		return getYukkuriById(other.getParents()[Parent.MAMA.ordinal()]) == self;
	}
	...
	public static boolean isPartner(SocialEntity self, SocialEntity other) {
		...
		Yukkuri partner = getYukkuriById(self.getPartner());
	...
	public static boolean isSister(SocialEntity self, SocialEntity other) {
		if (getYukkuriById(self.getParents()[Parent.MAMA.ordinal()]) != null) {
			return self.getParents()[Parent.MAMA.ordinal()] == other.getParents()[Parent.MAMA.ordinal()];
		}
		if (getYukkuriById(self.getParents()[Parent.PAPA.ordinal()]) != null) {
	 ...
	 * @return 番のインスタンス
	 */
	public static Yukkuri getPartnerYukkuri(SocialEntity self) {
		return getYukkuriById(self.getPartner());
	}
	 ...
	 * @return 母親のインスタンス
	 */
	public static Yukkuri getMotherYukkuri(SocialEntity self) {
		return getYukkuriById(self.getMother());
	}
	 ...
	 * @return 父親のインスタンス
	 */
	public static Yukkuri getFatherYukkuri(SocialEntity self) {
		return getYukkuriById(self.getFather());
	}
	 ...
	 * @return 親インスタンス
	 */
	public static Yukkuri getParentYukkuri(int parentId) {
		return getYukkuriById(parentId);
	}
