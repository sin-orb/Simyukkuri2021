 ...
 * えーき
 */
public class Eiki extends Yukkuri {
	private static final long serialVersionUID = -8442445086608413455L;
	/** えーきのタイプ */
	public static final YukkuriType type = YukkuriType.EIKI;
	/** えーき和名 */
	...
	/** コンストラクタ */
	public Eiki(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
