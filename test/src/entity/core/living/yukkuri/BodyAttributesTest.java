...
public class BodyAttributesTest {
    ...
    class RegressionScenarios {
        ...
        void testScenario_BabyTypesDequeuePreservesInsertionOrderAcrossMultipleEntries() {
            src.entity.core.living.yukkuri.Dna first = new src.entity.core.living.yukkuri.Dna(src.enums.YukkuriType.MARISA, Attitude.NICE, Intelligence.AVERAGE, false);
            src.entity.core.living.yukkuri.Dna second = new src.entity.core.living.yukkuri.Dna(src.enums.YukkuriType.DOSMARISA, Attitude.SHITHEAD, Intelligence.WISE, true);
    ...
    class AttachmentTests {
        ...
        public void testAddAndCountAttachment() {
            ...
            assertEquals(0, b.getAttachmentSize(src.entity.core.attachment.impl.Ants.class));
        }
    ...
    class TakeoutItemTests {
        ...
        public void testGetTakeoutItemNotInFoodOrShitMaps() {
            ...
            // null
            Entity result = body.getCarryItem(src.enums.TakeoutItemType.YUKKURI);
            assertNull(result);
        }
