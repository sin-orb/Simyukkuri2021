...
public class SuwakoTest {
    ...
    public void testLoadImages_headless_executesCode() {
        try {
            ...
            java.lang.reflect.Field fl = Suwako.class.getDeclaredField("imageLoaded");
            fl.setAccessible(true);
            boolean oldVal = fl.getBoolean(null);
            fl.setBoolean(null, true);
            Suwako.loadImages(Suwako.class.getClassLoader(), null);
    ...
    public void testGetImage_executesCode() {
        try {
            ...
            java.lang.reflect.Field fp = Suwako.class.getDeclaredField("imagePack");
    ...
    public void testLoadIniFile_executesCode() {
        try {
            Suwako.loadIniFile(Suwako.class.getClassLoader());
        } catch (Exception e) { } finally {
            try {
                java.lang.reflect.Field fa = Suwako.class.getDeclaredField("AttachOffset");
