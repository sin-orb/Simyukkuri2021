 ...
 */
public final class YukkuriPartnerEntryRule {

	private YukkuriPartnerEntryRule() {
	}
	...
	public static Yukkuri resolveMappedTarget(Yukkuri body, int nearestDistance) {
		...
		if ((body.isToYukkuri() || body.isToSukkiri() || body.isToSteal()) && target instanceof Yukkuri) {
