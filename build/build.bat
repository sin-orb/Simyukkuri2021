...
javac -source 8 -target 8 -encoding UTF-8 -sourcepath ..\src\main\java -d classes ..\src\main\java\org\simyukkuri\SimYukkuri.java
...
jar cvfe SimYukkuri.jar org.simyukkuri.SimYukkuri -C classes . -C classes_lib . -C .. data -C .. images -C .. resources -C .. lib
