...
class YukkuriMessageDelegateTest {
	@Test
	void setMessageDelegatesToBodyEventState() {
		...
		new YukkuriMessageDelegate(body).setMessage("hello", true);
	...
	void setOrigMessageLineColorDelegatesToLivingEntityColor() {
		...
		new YukkuriMessageDelegate(body).setOrigMessageLineColor(new Color(1, 2, 3, 4));
