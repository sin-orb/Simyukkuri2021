...
public class ModLoader {
	 ...
	 */
	public static Vector<String> getBackThemes() {
	 ...
	 */
	public static Vector<String> getItemThemes() {
	 ...
	 */
	public static Vector<String> getYukkuriThemes() {
	 ...
	 * @throws IOException IO例外
	 */
	public static IniFileReader loadTerrainData(ClassLoader loader, String mapName, String iniName, String bgName)
			throws IOException {
	 ...
	 */
	public static int loadYukkuriIniValue(ClassLoader loader, String path, String name, String inKey) {
		int result = 0;
		IniFileReader iniFile = null;
		boolean jarTry = true;
	 ...
	 */
	public static String[] loadYukkuriIniStrings(ClassLoader loader, String path, String name, String inKey) {
		IniFileReader iniFile = null;
		boolean jarTry = true;
		...
		for (int i = 0; i < 3; i++) {
			...
			if (BB) {
				if (bodyImg[ImageCode.BRAID_BACK.ordinal()][0][i] != null) {
					...
					braidRect[i] = new Dimension4y(bodyImg[ImageCode.BRAID_BACK.ordinal()][1][i].getWidth(io),
							bodyImg[ImageCode.BRAID_BACK.ordinal()][1][i].getHeight(io));
				}
			} else {
				if (bodyImg[ImageCode.BRAID.ordinal()][0][i] != null) {
					braidRect[i] = new Dimension4y(bodyImg[ImageCode.BRAID.ordinal()][0][i].getWidth(io),
							bodyImg[ImageCode.BRAID.ordinal()][0][i].getHeight(io));
				} else if (bodyImg[ImageCode.BRAID.ordinal()][1][i] != null) {
					braidRect[i] = new Dimension4y(bodyImg[ImageCode.BRAID.ordinal()][1][i].getWidth(io),
							bodyImg[ImageCode.BRAID.ordinal()][1][i].getHeight(io));
				}
			}
		}
	}
