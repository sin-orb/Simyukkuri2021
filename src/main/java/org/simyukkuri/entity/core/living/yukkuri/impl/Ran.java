 ...
 * らん
 */
public class Ran extends Yukkuri {
	private static final long serialVersionUID = 871413423258206479L;
	/** らんのタイプ */
	public static final YukkuriType type = YukkuriType.RAN;
	/** らん和名 */
	...
	/** コンストラクタ */
	public Ran(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
