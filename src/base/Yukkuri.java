...
public abstract class Yukkuri extends SocialEntity {
	...
	public boolean isNoticeNoOkazari() { return noticeNoOkazari; }
	public void setNoticeNoOkazari(boolean noticeNoOkazari) { this.noticeNoOkazari = noticeNoOkazari; }

	// --- BodyNameSet fields ---
	/** 種族固有の画像ファイルベース名 */
	protected String baseBodyFileName;
	/** 種族固有の画像ファイルベース名 を取得する. @return 種族固有の画像ファイルベース名 */
	public String getBaseBodyFileName() { return baseBodyFileName; }
	/** 種族固有の画像ファイルベース名 を設定する. @param baseBodyFileName 種族固有の画像ファイルベース名 */
	public void setBaseBodyFileName(String baseBodyFileName) { this.baseBodyFileName = baseBodyFileName; }
	/** 赤ゆの一人称 */
	protected String[] babyNames;
	/** 赤ゆの一人称 を取得する. @return 赤ゆの一人称 */
	public String[] getBabyNames() { return babyNames; }
	/** 赤ゆの一人称 を設定する. @param babyNames 赤ゆの一人称 */
	public void setBabyNames(String[] babyNames) { this.babyNames = babyNames; }
	/** 子ゆの一人称 */
	protected String[] childNames;
	/** 子ゆの一人称 を取得する. @return 子ゆの一人称 */
	public String[] getChildNames() { return childNames; }
	/** 子ゆの一人称 を設定する. @param childNames 子ゆの一人称 */
	public void setChildNames(String[] childNames) { this.childNames = childNames; }
	/** 大人ゆの一人称 */
	protected String[] adultNames;
	/** 大人ゆの一人称 を取得する. @return 大人ゆの一人称 */
	public String[] getAdultNames() { return adultNames; }
	/** 大人ゆの一人称 を設定する. @param adultNames 大人ゆの一人称 */
	public void setAdultNames(String[] adultNames) { this.adultNames = adultNames; }
	/** 年齢別の一人称配列 */
	protected String[] myNames = new String[3];
	/** 年齢別の一人称配列 を取得する. @return 年齢別の一人称配列 */
	public String[] getMyNames() { return myNames; }
	/** 年齢別の一人称配列 を設定する. @param myNames 年齢別の一人称配列 */
	public void setMyNames(String[] myNames) { this.myNames = myNames; }
	/** 赤ゆの一人称（ダメージ時） */
	protected String[] babyNamesDamaged;
	/** 赤ゆの一人称（ダメージ時） を取得する. @return 赤ゆの一人称（ダメージ時） */
	public String[] getBabyNamesDamaged() { return babyNamesDamaged; }
	/** 赤ゆの一人称（ダメージ時） を設定する. @param babyNamesDamaged 赤ゆの一人称（ダメージ時） */
	public void setBabyNamesDamaged(String[] babyNamesDamaged) { this.babyNamesDamaged = babyNamesDamaged; }
	/** 子ゆの一人称（ダメージ時） */
	protected String[] childNamesDamaged;
	/** 子ゆの一人称（ダメージ時） を取得する. @return 子ゆの一人称（ダメージ時） */
	public String[] getChildNamesDamaged() { return childNamesDamaged; }
	/** 子ゆの一人称（ダメージ時） を設定する. @param childNamesDamaged 子ゆの一人称（ダメージ時） */
	public void setChildNamesDamaged(String[] childNamesDamaged) { this.childNamesDamaged = childNamesDamaged; }
	/** 大人ゆの一人称（ダメージ時） */
	protected String[] adultNamesDamaged;
	/** 大人ゆの一人称（ダメージ時） を取得する. @return 大人ゆの一人称（ダメージ時） */
	public String[] getAdultNamesDamaged() { return adultNamesDamaged; }
	/** 大人ゆの一人称（ダメージ時） を設定する. @param adultNamesDamaged 大人ゆの一人称（ダメージ時） */
	public void setAdultNamesDamaged(String[] adultNamesDamaged) { this.adultNamesDamaged = adultNamesDamaged; }
	/** 年齢別の一人称配列（ダメージ時） */
	protected String[] myNamesDamaged = new String[3];
	/** 年齢別の一人称配列（ダメージ時） を取得する. @return 年齢別の一人称配列（ダメージ時） */
	public String[] getMyNamesDamaged() { return myNamesDamaged; }
	/** 年齢別の一人称配列（ダメージ時） を設定する. @param myNamesDamaged 年齢別の一人称配列（ダメージ時） */
	public void setMyNamesDamaged(String[] myNamesDamaged) { this.myNamesDamaged = myNamesDamaged; }
