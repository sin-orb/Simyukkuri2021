...
public class ChirunoTest {
    ...
    public void testChirunoIdentity() {
        ...
        assertEquals(1006, chiruno.getType());
    ...
    @Test
    public void testChirunoIsImageLoaded() {
        Chiruno obj = new Chiruno();
    ...
    @Test
    public void testChirunoKillTime() {
        try {
    ...
    @Test
    public void testChirunoJudgeCanTransForGodHandWhenUnbirth() {
        Chiruno obj = new Chiruno();
    ...
    @Test
    public void testChirunoJudgeCanTransForGodHandWhenAdult() {
        Chiruno parent1 = new Chiruno();
        Chiruno parent2 = new Chiruno();
        Chiruno obj = new Chiruno(100, 100, 0, AgeState.ADULT, parent1, parent2);
    ...
    @Test
    public void testChirunoJudgeCanTransForGodHandWhenBaby() {
        Chiruno parent1 = new Chiruno();
        Chiruno parent2 = new Chiruno();
        Chiruno obj = new Chiruno(100, 100, 0, AgeState.BABY, parent1, parent2);
    ...
    @Test
    public void testChirunoKillTimeMultipleBranches() {
        try {
            src.util.WorldTestHelper.initializeMinimalWorld();
    ...
    @Test
    public void testChirunoKillTimeSequence() {
        try {
            src.util.WorldTestHelper.initializeMinimalWorld();
    ...
    public void testLoadImages_headless_executesCode() {
        try {
            ...
            java.lang.reflect.Field fl = Chiruno.class.getDeclaredField("imageLoaded");
            fl.setAccessible(true);
            boolean oldVal = fl.getBoolean(null);
            fl.setBoolean(null, true);
            Chiruno.loadImages(Chiruno.class.getClassLoader(), null);
    ...
    public void testGetImage_executesCode() {
        try {
            ...
            java.lang.reflect.Field fp = Chiruno.class.getDeclaredField("imagePack");
    ...
    public void testLoadIniFile_executesCode() {
        try {
            Chiruno.loadIniFile(Chiruno.class.getClassLoader());
        } catch (Exception e) { } finally {
            try {
                java.lang.reflect.Field fa = Chiruno.class.getDeclaredField("AttachOffset");
