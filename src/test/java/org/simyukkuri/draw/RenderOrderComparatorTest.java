...
class RenderOrderComparatorTest {
    ...
    void testGetInstanceNonNull() {
        assertNotNull(RenderOrderComparator.getInstance());
    }

    @Test
    void testGetInstanceSingleton() {
        assertSame(RenderOrderComparator.getInstance(), RenderOrderComparator.getInstance());
    }
    ...
    void testCompareO1YLessThanO2YReturnsNegative() {
        ...
        assertTrue(RenderOrderComparator.getInstance().compare(o1, o2) < 0);
    }
    ...
    void testCompareSameYBothNonBodyReturnsZero() {
        ...
        assertEquals(0, RenderOrderComparator.getInstance().compare(o1, o2));
    }
    ...
    void testCompareSameYBabyVsAdult() {
        ...
        int result = RenderOrderComparator.getInstance().compare(baby, adult);
    ...
    void testCompareSameYAdultVsBaby() {
        ...
        int result = RenderOrderComparator.getInstance().compare(adult, baby);
    ...
    void testCompareSameYBodyVsObj() {
        ...
        int result = RenderOrderComparator.getInstance().compare(body, obj);
    ...
    void testCompareSameYObjVsBody() {
        ...
        int result = RenderOrderComparator.getInstance().compare(obj, body);
    ...
    void testCompareSameYBabyBodyVsObj() {
        ...
        int result = RenderOrderComparator.getInstance().compare(baby, obj);
