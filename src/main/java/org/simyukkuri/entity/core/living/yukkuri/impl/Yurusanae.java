...
public class Yurusanae extends Yukkuri {
	...
	/** ゆるさなえのタイプ */
	public static final YukkuriType type = YukkuriType.YURUSANAE;
	/** ゆるさなえ和名 */
	public static final String nameJ = "さなえ";
	/** ゆるさなえ英名 */
	public static final String nameE = "Yurusanae";
	/** ゆるさなえベースファイル名 */
	public static final String baseFileName = "yurusanae";
	...
	public Yurusanae(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
		...
		setShitType(YukkuriType.YURUSANAE);
