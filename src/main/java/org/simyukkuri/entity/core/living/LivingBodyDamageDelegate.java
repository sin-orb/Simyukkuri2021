 ...
 */
public final class LivingBodyDamageDelegate {
	private final LivingEntity body;

	public LivingBodyDamageDelegate(LivingEntity body) {
		this.body = body;
	}
	...
	private void applyExternalDamage(boolean healFlag) {
		...
		if (GameEnvironment.isSugerSteam()
				&& body.damage >= body.getDamageLimitBase()[body.getBodyAgeState().ordinal()] * 80 / 100
				&& healFlag) {
