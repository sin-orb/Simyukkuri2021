...
public class BodyBehaviorTest {
    ...
    public void testCheckFire_Propagation() throws Exception {
        ...
        assertTrue(neighbor.getAttachmentSize(src.entity.core.attachment.impl.Fire.class) > 0);
    }
    ...
    class RegressionScenarios {
        ...
        void testScenario_FireDoesNotPropagateToDistantBody() throws Exception {
            ...
            assertEquals(0, distant.getAttachmentSize(src.entity.core.attachment.impl.Fire.class));
        }
