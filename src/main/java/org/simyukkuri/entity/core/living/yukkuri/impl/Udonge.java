...
public class Udonge extends Yukkuri {
	...
	/** うどんげのタイプ */
	public static final YukkuriType type = YukkuriType.UDONGE;
	/** うどんげ和名 */
	public static final String nameJ = "うどんげ";
	/** うどんげ英名 */
	public static final String nameE = "Udonge";
	/** うどんげベースファイル名 */
	public static final String baseFileName = "udonge";
	...
	public Udonge(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
		...
		setShitType(YukkuriType.UDONGE);
