...
/*				case WAIT:
				...
				case START:
					if( checkWait(b,nWait) ){
						if( !bActionFlag ){
							b.setBodyEventResMessage(MessagePool.getMessage(b, MessagePool.Action.ProudChildsSTARTFrom), 52, true, false);
							bActionFlag = true;
							b.stay(nWait2+10);
							b.addMemories(10);
						}
				...
				case SING:
					...
					{
						if( !bActionFlag ){
							b.setBodyEventResMessage(MessagePool.getMessage(b, MessagePool.Action.ProudChildsSING), 52, true, false);
				...
				case PROUD:
					if( checkWait(b,nWait)){
						if( !bActionFlag ){
							b.setBodyEventResMessage(MessagePool.getMessage(b, MessagePool.Action.ProudChildsPROUDFrom), 52, true, false);
							b.getInVain(false);
							bActionFlag = true;
							b.stay(nWait2);
				...
				case END:
					if( checkWait(b,nWait) ){
						if( !bActionFlag ){
							b.setBodyEventResMessage(MessagePool.getMessage(b, MessagePool.Action.ProudChildsENDFrom), 52, true, false);
							bActionFlag = true;
							b.stay(52);
							b.addMemories(10);
							b.setHappiness(Happiness.VERY_HAPPY);
...
/*				case WAIT:
				...
				case START:
					...
					{
						if( checkWait(b,nWait)){
							b.setBodyEventResMessage(MessagePool.getMessage(b, MessagePool.Action.ProudChildsSTART), 52, true, false);
							b.stay(nWait2);
							b.addMemories(10);
						}
					}
				...
				case PROUD:
					if( bActionFlag){
						if( checkWait(b,nWait) ){
							b.setBodyEventResMessage(MessagePool.getMessage(b, MessagePool.Action.ProudChildsPROUD), 52, true, false);
					...
					break;
				case END:
					if(b.isRude())b.setBodyEventResMessage(MessagePool.getMessage(b, MessagePool.Action.ProudChildsEND), 52, true, false);
					b.stay(52);
				default:
					break;
			}
