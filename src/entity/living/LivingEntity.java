...
public abstract class LivingEntity extends Entity {
	...
	/** 蓄積ダメージ counter indicating damage を取得する. @return 蓄積ダメージ counter indicating damage */
	...
	public void setDamageState(Damage damageState) { this.damageState = damageState; }

	@com.fasterxml.jackson.annotation.JsonIgnore
	public boolean isDamaged() { return getDamageState() == Damage.VERY || getDamageState() == Damage.TOOMUCH; }
	@com.fasterxml.jackson.annotation.JsonIgnore
	public boolean isDamagedHeavily() { return getDamageState() == Damage.TOOMUCH; }
	...
	/** 空腹度 counter indicating how hungry を取得する. @return 空腹度 counter indicating how hungry */
	public int getHungry() { return hungry; }
	/** 空腹度 counter indicating how hungry を設定する. @param hungry 空腹度 counter indicating how hungry */
	...
	public int getDeadPeriod() { return deadPeriod; }
	/** 死んでからの期間 を設定する. @param deadPeriod 死んでからの期間 */
	public void setDeadPeriod(int deadPeriod) { this.deadPeriod = deadPeriod; }

	/** 中枢餡の状態（非ゆっくり症フラグ を取得する. @return 中枢餡の状態（非ゆっくり症フラグ */
	public CoreAnkoState getCoreAnkoState() { return coreAnkoState; }
	...
	public boolean isNightmare() { return nightmare; }
	...
	public boolean isStubbornlyDirty() { return !dead && stubbornlyDirty; }
	/** 頑固な汚れ有無 を設定する. @param stubbornlyDirty 頑固な汚れ有無 */
	public void setStubbornlyDirty(boolean stubbornlyDirty) { this.stubbornlyDirty = stubbornlyDirty; }

	/** 汚れている期間 を取得する. @return 汚れている期間 */
	public int getDirtyPeriod() { return dirtyPeriod; }
	/** 汚れている期間 を設定する. @param dirtyPeriod 汚れている期間 */
	public void setDirtyPeriod(int dirtyPeriod) { this.dirtyPeriod = dirtyPeriod; }

	/** 汚れて泣き叫ぶ期間 を取得する. @return 汚れて泣き叫ぶ期間 */
	public int getDirtyScreamPeriod() { return dirtyScreamPeriod; }
	/** 汚れて泣き叫ぶ期間 を設定する. @param dirtyScreamPeriod 汚れて泣き叫ぶ期間 */
	public void setDirtyScreamPeriod(int dirtyScreamPeriod) { this.dirtyScreamPeriod = dirtyScreamPeriod; }
	...
	public int getWetPeriod() { return wetPeriod; }
	/** 濡れている期間 を設定する. @param wetPeriod 濡れている期間 */
	public void setWetPeriod(int wetPeriod) { this.wetPeriod = wetPeriod; }

	/** 水に溶けた状態 を取得する. @return 水に溶けた状態 */
	public boolean isMelt() { return melt; }
	/** 水に溶けた状態 を設定する. @param melt 水に溶けた状態 */
	public void setMelt(boolean melt) { this.melt = melt; }

	/** 皮をむいた状態 を取得する. @return 皮をむいた状態 */
	public boolean isPealed() { return pealed; }
	/** 皮をむいた状態 を設定する. @param pealed 皮をむいた状態 */
	public void setPealed(boolean pealed) { this.pealed = pealed; }
	...
	public boolean isPheromone() { return pheromone; }
	/** フェロモンの有無 を設定する. @param pheromone フェロモンの有無 */
	public void setPheromone(boolean pheromone) { this.pheromone = pheromone; }

	/** おさげ、羽、尻尾有無 種族として何も持っていないものはtrue を取得する. @return おさげ、羽、尻尾有無 種族として何も持っていないものはtrue */
	public boolean isHasBraid() { return hasBraid; }
	/** おさげ、羽、尻尾有無 種族として何も持っていないものはtrue を設定する. @param hasBraid おさげ、羽、尻尾有無 種族として何も持っていないものはtrue */
	public void setHasBraid(boolean hasBraid) { this.hasBraid = hasBraid; }

	/** 種族としてお下げ、羽、尻尾を持つか を取得する. @return 種族としてお下げ、羽、尻尾を持つか */
	public boolean isBraidType() { return braidType; }
	/** 種族としてお下げ、羽、尻尾を持つか を設定する. @param braidType 種族としてお下げ、羽、尻尾を持つか */
	public void setBraidType(boolean braidType) { this.braidType = braidType; }

	/** おくるみ有無 true if having pants を取得する. @return おくるみ有無 true if having pants */
	public boolean isHasPants() { return hasPants; }
	/** おくるみ有無 true if having pants を設定する. @param hasPants おくるみ有無 true if having pants */
	public void setHasPants(boolean hasPants) { this.hasPants = hasPants; }

	/** あにゃるふさぎ有無 を取得する. @return あにゃるふさぎ有無 */
	public boolean isAnalClose() { return analClose; }
	/** あにゃるふさぎ有無 を設定する. @param analClose あにゃるふさぎ有無 */
	public void setAnalClose(boolean analClose) { this.analClose = analClose; }

	/** 胎生去勢有無 を取得する. @return 胎生去勢有無 */
	public boolean isBodyCastration() { return bodyCastration; }
	/** 胎生去勢有無 を設定する. @param bodyCastration 胎生去勢有無 */
	public void setBodyCastration(boolean bodyCastration) { this.bodyCastration = bodyCastration; }

	/** 茎去勢有無 を取得する. @return 茎去勢有無 */
	public boolean isStalkCastration() { return stalkCastration; }
	/** 茎去勢有無 を設定する. @param stalkCastration 茎去勢有無 */
	public void setStalkCastration(boolean stalkCastration) { this.stalkCastration = stalkCastration; }
	...
	public HairState getHairState() { return hairState; }
	/** 髪の状態 を設定する. @param hairState 髪の状態 */
	public void setHairState(HairState hairState) { this.hairState = hairState; }
	...
	public boolean isRareType() { return rareType; }
	/** 希少種か を設定する. @param rareType 希少種か */
	public void setRareType(boolean rareType) { this.rareType = rareType; }

	/** 捕食種タイプ を取得する. @return 捕食種タイプ */
	public PredatorType getPredatorType() { return predatorType; }
	/** 捕食種タイプ を設定する. @param predatorType 捕食種タイプ */
	public void setPredatorType(PredatorType predatorType) { this.predatorType = predatorType; }

	/** 苦いえさが好きか を取得する. @return 苦いえさが好きか */
	public boolean isLikeBitterFood() { return likeBitterFood; }
	/** 苦いえさが好きか を設定する. @param likeBitterFood 苦いえさが好きか */
	public void setLikeBitterFood(boolean likeBitterFood) { this.likeBitterFood = likeBitterFood; }

	/** 辛いえさが好きか を取得する. @return 辛いえさが好きか */
	public boolean isLikeHotFood() { return likeHotFood; }
	/** 辛いえさが好きか を設定する. @param likeHotFood 辛いえさが好きか */
	public void setLikeHotFood(boolean likeHotFood) { this.likeHotFood = likeHotFood; }
	...
	public long getBirthAge() { return birthAge; }
	/** 生まれてからの基準年齢 を設定する. @param birthAge 生まれてからの基準年齢 */
	public void setBirthAge(long birthAge) { this.birthAge = birthAge; }

	/** 実ゆかどうか を取得する. @return 実ゆかどうか */
	public boolean isUnBirth() { return unBirth; }
	/** 実ゆかどうか を設定する. @param unBirth 実ゆかどうか */
	public void setUnBirth(boolean unBirth) { this.unBirth = unBirth; }
	...
	public CriticalDamegeType getCriticalDamege() { return criticalDamege; }
	/** 致命傷種別 を設定する. @param criticalDamege 致命傷種別 */
	public void setCriticalDamege(CriticalDamegeType criticalDamege) { this.criticalDamege = criticalDamege; }
	...
	public int getNoDamagePeriod() { return noDamagePeriod; }
	/** ダメージを受けていない期間 を設定する. @param noDamagePeriod ダメージを受けていない期間 */
	public void setNoDamagePeriod(int noDamagePeriod) { this.noDamagePeriod = noDamagePeriod; }

	/** 飢餓状態になっていない期間 を取得する. @return 飢餓状態になっていない期間 */
	public int getNoHungryPeriod() { return noHungryPeriod; }
	/** 飢餓状態になっていない期間 を設定する. @param noHungryPeriod 飢餓状態になっていない期間 */
	public void setNoHungryPeriod(int noHungryPeriod) { this.noHungryPeriod = noHungryPeriod; }

	/** スーパーむーしゃむーしゃタイムのおかげで飢餓状態にならない期間 を取得する. @return スーパーむーしゃむーしゃタイムのおかげで飢餓状態にならない期間 */
	public int getSuperEatingNoHungryPeriod() { return superEatingNoHungryPeriod; }
	/** スーパーむーしゃむーしゃタイムのおかげで飢餓状態にならない期間 を設定する. @param v スーパーむーしゃむーしゃタイムのおかげで飢餓状態にならない期間 */
	public void setSuperEatingNoHungryPeriod(int v) { this.superEatingNoHungryPeriod = v; }

	/** 足焼きされている期間 を取得する. @return 足焼きされている期間 */
	public int getFootBakePeriod() { return footBakePeriod; }
	/** 足焼きされている期間 を設定する. @param footBakePeriod 足焼きされている期間 */
	public void setFootBakePeriod(int footBakePeriod) { this.footBakePeriod = footBakePeriod; }

	/** 焼かれている期間 を取得する. @return 焼かれている期間 */
	public int getBodyBakePeriod() { return bodyBakePeriod; }
	/** 焼かれている期間 を設定する. @param bodyBakePeriod 焼かれている期間 */
	public void setBodyBakePeriod(int bodyBakePeriod) { this.bodyBakePeriod = bodyBakePeriod; }

	/** 非ゆっくり症にかかっている期間 を取得する. @return 非ゆっくり症にかかっている期間 */
	public int getNonYukkuriDiseasePeriod() { return nonYukkuriDiseasePeriod; }
	/** 非ゆっくり症にかかっている期間 を設定する. @param v 非ゆっくり症にかかっている期間 */
	public void setNonYukkuriDiseasePeriod(int v) { this.nonYukkuriDiseasePeriod = v; }

	/** 怒っている期間 を取得する. @return 怒っている期間 */
	public int getAngryPeriod() { return angryPeriod; }
	/** 怒っている期間 を設定する. @param angryPeriod 怒っている期間 */
	public void setAngryPeriod(int angryPeriod) { this.angryPeriod = angryPeriod; }

	/** 怖がっている期間 を取得する. @return 怖がっている期間 */
	public int getScarePeriod() { return scarePeriod; }
	/** 怖がっている期間 を設定する. @param scarePeriod 怖がっている期間 */
	public void setScarePeriod(int scarePeriod) { this.scarePeriod = scarePeriod; }

	/** 悲しんでいる期間 を取得する. @return 悲しんでいる期間 */
	public int getSadPeriod() { return sadPeriod; }
	/** 悲しんでいる期間 を設定する. @param sadPeriod 悲しんでいる期間 */
	public void setSadPeriod(int sadPeriod) { this.sadPeriod = sadPeriod; }
	...
	public void setSickPeriod(int sickPeriod) { this.sickPeriod = sickPeriod; }

	/** 落下ダメージ を取得する. @return 落下ダメージ */
	public int getFalldownDamage() { return falldownDamage; }
	/** 落下ダメージ を設定する. @param falldownDamage 落下ダメージ */
	public void setFalldownDamage(int falldownDamage) { this.falldownDamage = falldownDamage; }

	/** 次の落下でダメージを受けないかどうか を取得する. @return 次の落下でダメージを受けないかどうか */
	public boolean isNoDamageNextFall() { return noDamageNextFall; }
	/** 次の落下でダメージを受けないかどうか を設定する. @param noDamageNextFall 次の落下でダメージを受けないかどうか */
	public void setNoDamageNextFall(boolean noDamageNextFall) { this.noDamageNextFall = noDamageNextFall; }

	/** 死なない期間 を取得する. @return 死なない期間 */
	public int getCantDiePeriod() { return cantDiePeriod; }
	/** 死なない期間 を設定する. @param cantDiePeriod 死なない期間 */
	public void setCantDiePeriod(int cantDiePeriod) { this.cantDiePeriod = cantDiePeriod; }

	/** 埋まり状態 を取得する. @return 埋まり状態 */
	public BurialState getBurialState() { return burialState; }
	/** 埋まり状態 を設定する. @param burialState 埋まり状態 */
	public void setBurialState(BurialState burialState) { this.burialState = burialState; }
	...
	public Okazari getOkazari() { return okazari; }
	/** おかざりオブジェクト を設定する. @param okazari おかざりオブジェクト */
	public void setOkazari(Okazari okazari) { this.okazari = okazari; }

	/** おかざりの位置 を取得する. @return おかざりの位置 */
	public int getOkazariPosition() { return okazariPosition; }
	/** おかざりの位置 を設定する. @param okazariPosition おかざりの位置 */
	public void setOkazariPosition(int okazariPosition) { this.okazariPosition = okazariPosition; }

	/** 赤ちゃんを持っているか を取得する. @return 赤ちゃんを持っているか */
	public boolean isHasBaby() { return hasBaby; }
	/** 赤ちゃんを持っているか を設定する. @param hasBaby 赤ちゃんを持っているか */
	public void setHasBaby(boolean hasBaby) { this.hasBaby = hasBaby; }

	/** 茎を持っているか を取得する. @return 茎を持っているか */
	public boolean isHasStalk() { return hasStalk; }
	/** 茎を持っているか を設定する. @param hasStalk 茎を持っているか */
	public void setHasStalk(boolean hasStalk) { this.hasStalk = hasStalk; }

	/** 子供のDNAリスト を取得する. @return 子供のDNAリスト */
	public List<Dna> getBabyTypes() { return babyTypes; }
	/** 子供のDNAリスト を設定する. @param babyTypes 子供のDNAリスト */
	public void setBabyTypes(List<Dna> babyTypes) { this.babyTypes = babyTypes; }

	/** 茎育ちの子供のDNAリスト を取得する. @return 茎育ちの子供のDNAリスト */
	public List<Dna> getStalkBabyTypes() { return stalkBabyTypes; }
	/** 茎育ちの子供のDNAリスト を設定する. @param stalkBabyTypes 茎育ちの子供のDNAリスト */
	public void setStalkBabyTypes(List<Dna> stalkBabyTypes) { this.stalkBabyTypes = stalkBabyTypes; }

	/** 茎リスト を取得する. @return 茎リスト */
	public List<Stalk> getStalks() { return stalks; }
	/** 茎リスト を設定する. @param stalks 茎リスト */
	public void setStalks(List<Stalk> stalks) { this.stalks = stalks; }

	/** 結びついている茎 を取得する. @return 結びついている茎 */
	public Stalk getBindStalk() { return bindStalk; }
	/** 結びついている茎 を設定する. @param bindStalk 結びついている茎 */
	public void setBindStalk(Stalk bindStalk) { this.bindStalk = bindStalk; }

	/** アタッチメントリスト を取得する. @return アタッチメントリスト */
	public List<Attachment> getAttach() { return attach; }
	/** アタッチメントリスト を設定する. @param attach アタッチメントリスト */
	public void setAttach(List<Attachment> attach) { this.attach = attach; }

	/** 餡子の量 を取得する. @return 餡子の量 */
	public int getAnkoAmount() { return ankoAmount; }
	/** 餡子の量 を設定する. @param ankoAmount 餡子の量 */
	public void setAnkoAmount(int ankoAmount) { this.ankoAmount = ankoAmount; }

	/** お気に入りアイテムマップ を取得する. @return お気に入りアイテムマップ */
	public HashMap<FavItemType, Integer> getFavoriteItems() { return favoriteItems; }
	/** お気に入りアイテムマップ を設定する. @param favoriteItems お気に入りアイテムマップ */
	public void setFavoriteItems(HashMap<FavItemType, Integer> favoriteItems) { this.favoriteItems = favoriteItems; }

	/** 持ち物マップ を取得する. @return 持ち物マップ */
	public HashMap<TakeoutItemType, Integer> getCarryItems() { return carryItems; }
	/** 持ち物マップ を設定する. @param carryItems 持ち物マップ */
	public void setCarryItems(HashMap<TakeoutItemType, Integer> carryItems) { this.carryItems = carryItems; }
	...
	/** 移動量 how many steps to same direction を取得する. @return 移動量 how many steps to same direction */
	public int getCountX() { return countX; }
	/** 移動量 how many steps to same direction を設定する. @param countX 移動量 how many steps to same direction */
	public void setCountX(int countX) { this.countX = countX; }
	/** 移動量 how many steps to same direction */
	protected int countY = 0;
	/** 移動量 how many steps to same direction を取得する. @return 移動量 how many steps to same direction */
	public int getCountY() { return countY; }
	/** 移動量 how many steps to same direction を設定する. @param countY 移動量 how many steps to same direction */
	public void setCountY(int countY) { this.countY = countY; }
	/** 移動量 how many steps to same direction */
	protected int countZ = 0;
	/** 移動量 how many steps to same direction を取得する. @return 移動量 how many steps to same direction */
	public int getCountZ() { return countZ; }
	/** 移動量 how many steps to same direction を設定する. @param countZ 移動量 how many steps to same direction */
	public void setCountZ(int countZ) { this.countZ = countZ; }
	...
	public void setDirZ(int dirZ) { this.dirZ = dirZ; }
	...
	public PurposeOfMoving getPurposeOfMoving() { return purposeOfMoving; }
	/** 移動目的 を設定する. @param purposeOfMoving 移動目的 */
	public void setPurposeOfMoving(PurposeOfMoving purposeOfMoving) { this.purposeOfMoving = purposeOfMoving; }
	/** ひっぱり、押しつぶし可能か */
	protected boolean canPullOrPush = false;
	/** ひっぱり、押しつぶし可能か を取得する. @return ひっぱり、押しつぶし可能か */
	public boolean canPullOrPush() { return canPullOrPush; }
	/** ひっぱり、押しつぶし可能か を設定する. @param canPullOrPush ひっぱり、押しつぶし可能か */
	public void setCanPullOrPush(boolean canPullOrPush) { this.canPullOrPush = canPullOrPush; }
	/** ゆっくりの移動速度 */
	...
	/** 外圧 を取得する. @return 外圧 */
	public int getExternalPressure() { return externalPressure; }
	/** 外圧 を設定する. @param externalPressure 外圧 */
	public void setExternalPressure(int externalPressure) { this.externalPressure = externalPressure; }
	/** 移動対象（移動先） */
	protected int moveTargetId = -1;
	/** 移動対象（移動先） を取得する. @return 移動対象（移動先） */
	public int getMoveTargetId() { return moveTargetId; }
	/** 移動対象（移動先） を設定する. @param moveTargetId 移動対象（移動先） */
	public void setMoveTargetId(int moveTargetId) { this.moveTargetId = moveTargetId; }
	/** 移動対象のX座標オフセット */
	protected int targetOffsetX = 0;
	/** 移動対象のX座標オフセット を取得する. @return 移動対象のX座標オフセット */
	public int getTargetOffsetX() { return targetOffsetX; }
	/** 移動対象のX座標オフセット を設定する. @param targetOffsetX 移動対象のX座標オフセット */
	public void setTargetOffsetX(int targetOffsetX) { this.targetOffsetX = targetOffsetX; }
	/** 移動対象のY座標オフセット */
	protected int targetOffsetY = 0;
	/** 移動対象のY座標オフセット を取得する. @return 移動対象のY座標オフセット */
	public int getTargetOffsetY() { return targetOffsetY; }
	/** 移動対象のY座標オフセット を設定する. @param targetOffsetY 移動対象のY座標オフセット */
	public void setTargetOffsetY(int targetOffsetY) { this.targetOffsetY = targetOffsetY; }
	/** うんうんアクション中 */
	...
	public boolean isPikopiko() { return pikopiko; }
	/** ぴこぴこ中 を設定する. @param pikopiko ぴこぴこ中 */
	public void setPikopiko(boolean pikopiko) { this.pikopiko = pikopiko; }
	/** ぷるぷる中 */
	protected boolean purupuru = false;
	/** ぷるぷる中 を取得する. @return ぷるぷる中 */
	public boolean isPurupuru() { return purupuru; }
	/** ぷるぷる中 を設定する. @param purupuru ぷるぷる中 */
	public void setPurupuru(boolean purupuru) { this.purupuru = purupuru; }
	/** ゆんやぁ中 */
	...
	public boolean isShutmouth() { return shutmouth; }
	/** 口ふさがれ中 を設定する. @param shutmouth 口ふさがれ中 */
	public void setShutmouth(boolean shutmouth) { this.shutmouth = shutmouth; }
	/** 命乞い中 */
	...
	public PlayStyle getPlaying() { return playing; }
	/** 何で遊んでいるか を設定する. @param playing 何で遊んでいるか */
	public void setPlaying(PlayStyle playing) { this.playing = playing; }
	/** 遊び時間上限 */
	...
	public boolean isShakePhase() { return shakePhase; }
	/** ぷるぷるアニメーションの位相(左右揺れのトグル) を設定する. @param shakePhase ぷるぷるアニメーションの位相(左右揺れのトグル) */
	public void setShakePhase(boolean shakePhase) { this.shakePhase = shakePhase; }
	/** 粘着板で背中を固定されている */
	protected boolean fixBack = false;
	/** 粘着板で背中を固定されている を取得する. @return 粘着板で背中を固定されている */
	public boolean isFixBack() { return fixBack; }
	/** 粘着板で背中を固定されている を設定する. @param fixBack 粘着板で背中を固定されている */
	public void setFixBack(boolean fixBack) { this.fixBack = fixBack; }
	/** 待機アクション中 */
	...
	public void setStaying(boolean staying) { this.staying = staying; }
	/** その場に留まってる回数 */
	...
	public void setStayTicks(int stayTicks) { this.stayTicks = stayTicks; }
	/** とどまる限界 */
	...
	public String getMessageBuffer() { return messageBuffer; }
	/** メッセージのバッファ を設定する. @param messageBuffer メッセージのバッファ */
	public void setMessageBuffer(String messageBuffer) { this.messageBuffer = messageBuffer; }
	/** いくつメッセージが溜まってるか */
	protected int messageTicks = 0;
	/** いくつメッセージが溜まってるか を取得する. @return いくつメッセージが溜まってるか */
	public int getMessageTicks() { return messageTicks; }
	/** いくつメッセージが溜まってるか を設定する. @param messageTicks いくつメッセージが溜まってるか */
	public void setMessageTicks(int messageTicks) { this.messageTicks = messageTicks; }
	/** メッセージラインの色 */
	protected Color4y messageLineColor;
	/** メッセージラインの色 を取得する. @return メッセージラインの色 */
	public Color4y getMessageLineColor() { return messageLineColor; }
	/** メッセージラインの色 を設定する. @param messageLineColor メッセージラインの色 */
	public void setMessageLineColor(Color4y messageLineColor) { this.messageLineColor = messageLineColor; }
	/** メッセージボックスの色 */
	protected Color4y messageBoxColor;
	/** メッセージボックスの色 を取得する. @return メッセージボックスの色 */
	public Color4y getMessageBoxColor() { return messageBoxColor; }
	/** メッセージボックスの色 を設定する. @param messageBoxColor メッセージボックスの色 */
	public void setMessageBoxColor(Color4y messageBoxColor) { this.messageBoxColor = messageBoxColor; }
	/** メッセージテキストの色 */
	protected Color4y messageTextColor;
	/** メッセージテキストの色 を取得する. @return メッセージテキストの色 */
	public Color4y getMessageTextColor() { return messageTextColor; }
	/** メッセージテキストの色 を設定する. @param messageTextColor メッセージテキストの色 */
	public void setMessageTextColor(Color4y messageTextColor) { this.messageTextColor = messageTextColor; }
	/** メッセージストローク */
	protected BasicStrokeEX messageWindowStroke;
	/** メッセージストローク を取得する. @return メッセージストローク */
	public BasicStrokeEX getMessageWindowStroke() { return messageWindowStroke; }
	/** メッセージストローク を設定する. @param messageWindowStroke メッセージストローク */
	public void setMessageWindowStroke(BasicStrokeEX messageWindowStroke) { this.messageWindowStroke = messageWindowStroke; }
	/** メッセージテキストのサイズ */
	protected int messageTextSize;
	/** メッセージテキストのサイズ を取得する. @return メッセージテキストのサイズ */
	public int getMessageTextSize() { return messageTextSize; }
	/** メッセージテキストのサイズ を設定する. @param messageTextSize メッセージテキストのサイズ */
	public void setMessageTextSize(int messageTextSize) { this.messageTextSize = messageTextSize; }
	...
	public boolean isBirthMessageForced() { return birthMessageForced; }
	/** 強制的に誕生時メッセージを言わされるかどうか を設定する. @param birthMessageForced 強制的に誕生時メッセージを言わされるかどうか */
	public void setBirthMessageForced(boolean birthMessageForced) { this.birthMessageForced = birthMessageForced; }
	/** 影の表示有無 */
	...
	public boolean isImageNagasiMode() { return imageNagasiMode; }
	/** 画像がまりちゃ流しか を設定する. @param imageNagasiMode 画像がまりちゃ流しか */
	public void setImageNagasiMode(boolean imageNagasiMode) { this.imageNagasiMode = imageNagasiMode; }
	/** まばたき、同じ表情の時にカウント */
	...
	public int getBlinkType() { return blinkType; }
	/** まばたき、表情の値を代入 を設定する. @param blinkType まばたき、表情の値を代入 */
	public void setBlinkType(int blinkType) { this.blinkType = blinkType; }
	/** うにょ機能を使用するかどうかのフラグ */
	protected int unyoMode = 1;
	/** うにょ機能を使用するかどうかのフラグ を取得する. @return うにょ機能を使用するかどうかのフラグ */
	public int getUnyoMode() { return unyoMode; }
	/** うにょ機能を使用するかどうかのフラグ を設定する. @param unyoMode うにょ機能を使用するかどうかのフラグ */
	public void setUnyoMode(int unyoMode) { this.unyoMode = unyoMode; }
	/** うにょの高さ方向 */
	protected int unyoOffsetH = 0;
	/** うにょの高さ方向 を取得する. @return うにょの高さ方向 */
	public int getUnyoOffsetH() { return unyoOffsetH; }
	/** うにょの高さ方向 を設定する. @param unyoOffsetH うにょの高さ方向 */
	public void setUnyoOffsetH(int unyoOffsetH) { this.unyoOffsetH = unyoOffsetH; }
	/** うにょの横方向 */
	protected int unyoOffsetW = 0;
	/** うにょの横方向 を取得する. @return うにょの横方向 */
	public int getUnyoOffsetW() { return unyoOffsetW; }
	/** うにょの横方向 を設定する. @param unyoOffsetW うにょの横方向 */
	public void setUnyoOffsetW(int unyoOffsetW) { this.unyoOffsetW = unyoOffsetW; }
	...
	public List<EventPacket> getEventList() { return eventList; }
	/** この個体に対して発行されたイベントのリスト を設定する. @param eventList この個体に対して発行されたイベントのリスト */
	public void setEventList(List<EventPacket> eventList) { this.eventList = eventList; }
	/** 現在実行中のイベント */
	protected EventPacket currentEvent = null;
	/** 現在実行中のイベント を取得する. @return 現在実行中のイベント */
	public EventPacket getCurrentEvent() { return currentEvent; }
	/** 現在実行中のイベント を設定する. @param currentEvent 現在実行中のイベント */
	public void setCurrentEvent(EventPacket currentEvent) { this.currentEvent = currentEvent; }
	/** イベントで設定されたアクション */
	protected Event eventResult = Event.DONOTHING;
	/** イベントで設定されたアクション を取得する. @return イベントで設定されたアクション */
	public Event getEventResult() { return eventResult; }
	/** イベントで設定されたアクション を設定する. @param eventResult イベントで設定されたアクション */
	public void setEventResult(Event eventResult) { this.eventResult = eventResult; }
	/** ゆっくりのオブジェクトのユニークID */
	...
	public YukkuriType getMsgType() { return msgType; }
	/** どのゆっくり的なメッセージを言うか を設定する. @param msgType どのゆっくり的なメッセージを言うか */
	public void setMsgType(YukkuriType msgType) { this.msgType = msgType; }
	/** どのゆっくり的なうんうんをするか */
	protected YukkuriType shitType = null;
	/** どのゆっくり的なうんうんをするか を取得する. @return どのゆっくり的なうんうんをするか */
	public YukkuriType getShitType() { return shitType; }
	/** どのゆっくり的なうんうんをするか を設定する. @param shitType どのゆっくり的なうんうんをするか */
	public void setShitType(YukkuriType shitType) { this.shitType = shitType; }
	/** ゆっくり本体の購入基本額 */
	...
	/** ゆっくり本体、中身の売却基本額 飼いゆとしての価値/加工品としての価値 を取得する. @return ゆっくり本体、中身の売却基本額 飼いゆとしての価値/加工品としての価値 */
	public int[] getSaleValues() { return saleValues; }
	/** ゆっくり本体、中身の売却基本額 飼いゆとしての価値/加工品としての価値 を設定する. @param saleValues ゆっくり本体、中身の売却基本額 飼いゆとしての価値/加工品としての価値 */
	public void setSaleValues(int[] saleValues) { this.saleValues = saleValues; }
	/** 「取る」で取られているかどうか */
	...
	public boolean isSurisuriFromPlayer() { return surisuriFromPlayer; }
	/** プレイヤーにすりすりされているか を設定する. @param surisuriFromPlayer プレイヤーにすりすりされているか */
	public void setSurisuriFromPlayer(boolean surisuriFromPlayer) { this.surisuriFromPlayer = surisuriFromPlayer; }
	/** 最後にプレイヤーにすりすりしてもらった時間 */
	protected long lastSurisuriTime = 0;
	/** 最後にプレイヤーにすりすりしてもらった時間 を取得する. @return 最後にプレイヤーにすりすりしてもらった時間 */
	public long getLastSurisuriTime() { return lastSurisuriTime; }
	/** 最後にプレイヤーにすりすりしてもらった時間 を設定する. @param lastSurisuriTime 最後にプレイヤーにすりすりしてもらった時間 */
	public void setLastSurisuriTime(long lastSurisuriTime) { this.lastSurisuriTime = lastSurisuriTime; }
	/** アイテムを出し入れする動作フラグ */
	protected boolean inOutTakeoutItem = false;
	/** アイテムを出し入れする動作フラグ を取得する. @return アイテムを出し入れする動作フラグ */
	public boolean isInOutTakeoutItem() { return inOutTakeoutItem; }
	/** アイテムを出し入れする動作フラグ を設定する. @param inOutTakeoutItem アイテムを出し入れする動作フラグ */
	public void setInOutTakeoutItem(boolean inOutTakeoutItem) { this.inOutTakeoutItem = inOutTakeoutItem; }
	/** ゆ虐神拳により 膨らんでいるか/伸ばされているか/押さえつけられているか */
	protected boolean[] abFlagGodHand = { false, false, false };
	/** ゆ虐神拳により 膨らんでいるか/伸ばされているか/押さえつけられているか を取得する. @return ゆ虐神拳により 膨らんでいるか/伸ばされているか/押さえつけられているか */
	public boolean[] getAbFlagGodHand() { return abFlagGodHand; }
	/** ゆ虐神拳により 膨らんでいるか/伸ばされているか/押さえつけられているか を設定する. @param abFlagGodHand ゆ虐神拳により 膨らんでいるか/伸ばされているか/押さえつけられているか */
	public void setAbFlagGodHand(boolean[] abFlagGodHand) { this.abFlagGodHand = abFlagGodHand; }
	/** ゆ虐神拳の回数 */
	protected int godHandHoldCount = 0;
	/** ゆ虐神拳の回数 を取得する. @return ゆ虐神拳の回数 */
	public int getGodHandHoldCount() { return godHandHoldCount; }
	/** ゆ虐神拳の回数 を設定する. @param godHandHoldCount ゆ虐神拳の回数 */
	public void setGodHandHoldCount(int godHandHoldCount) { this.godHandHoldCount = godHandHoldCount; }
	/** ゆ虐神拳の伸ばし回数 */
	protected int godHandStretchCount = 0;
	/** ゆ虐神拳の伸ばし回数 を取得する. @return ゆ虐神拳の伸ばし回数 */
	public int getGodHandStretchCount() { return godHandStretchCount; }
	/** ゆ虐神拳の伸ばし回数 を設定する. @param godHandStretchCount ゆ虐神拳の伸ばし回数 */
	public void setGodHandStretchCount(int godHandStretchCount) { this.godHandStretchCount = godHandStretchCount; }
	/** ゆ虐神拳の押しつぶし回数 */
	protected int godHandCompressCount = 0;
	/** ゆ虐神拳の押しつぶし回数 を取得する. @return ゆ虐神拳の押しつぶし回数 */
	public int getGodHandCompressCount() { return godHandCompressCount; }
	/** ゆ虐神拳の押しつぶし回数 を設定する. @param godHandCompressCount ゆ虐神拳の押しつぶし回数 */
	public void setGodHandCompressCount(int godHandCompressCount) { this.godHandCompressCount = godHandCompressCount; }
	/** たかっているアリの数 */
	...
	public boolean isNonMovingConveyor() { return nonMovingConveyor; }
	/** 移動不可ベルトコンベアの有無 を設定する. @param nonMovingConveyor 移動不可ベルトコンベアの有無 */
	public void setNonMovingConveyor(boolean nonMovingConveyor) { this.nonMovingConveyor = nonMovingConveyor; }
	...
	public int getBlockedTicks() { return blockedTicks; }
	/** 壁に引っかかった回数 を設定する. @param blockedTicks 壁に引っかかった回数 */
	public void setBlockedTicks(int blockedTicks) { this.blockedTicks = blockedTicks; }
	/** 出産期間のブースト（この分だけ早まる） */
	protected int pregnancyPeriodBoost = 0;
	/** 出産期間のブースト（この分だけ早まる） を取得する. @return 出産期間のブースト（この分だけ早まる） */
	public int getPregnancyPeriodBoost() { return pregnancyPeriodBoost; }
	/** 出産期間のブースト（この分だけ早まる） を設定する. @param pregnancyPeriodBoost 出産期間のブースト（この分だけ早まる） */
	public void setPregnancyPeriodBoost(int pregnancyPeriodBoost) { this.pregnancyPeriodBoost = pregnancyPeriodBoost; }
	/** 発情期間のブースト（この分だけ早まる） */
	protected int excitementPeriodBoost = 0;
	/** 発情期間のブースト（この分だけ早まる） を取得する. @return 発情期間のブースト（この分だけ早まる） */
	public int getExcitementPeriodBoost() { return excitementPeriodBoost; }
	/** 発情期間のブースト（この分だけ早まる） を設定する. @param excitementPeriodBoost 発情期間のブースト（この分だけ早まる） */
	public void setExcitementPeriodBoost(int excitementPeriodBoost) { this.excitementPeriodBoost = excitementPeriodBoost; }
	/** うんうんブースト */
	protected int excretionBoost = 0;
	/** うんうんブースト を取得する. @return うんうんブースト */
	public int getExcretionBoost() { return excretionBoost; }
	/** うんうんブースト を設定する. @param excretionBoost うんうんブースト */
	public void setExcretionBoost(int excretionBoost) { this.excretionBoost = excretionBoost; }
	/** うまれて初めての地面か */
	protected boolean firstGround = true;
	/** うまれて初めての地面か を取得する. @return うまれて初めての地面か */
	public boolean isFirstGround() { return firstGround; }
	/** うまれて初めての地面か を設定する. @param firstGround うまれて初めての地面か */
	public void setFirstGround(boolean firstGround) { this.firstGround = firstGround; }
	/** うまれて初めての食事か */
	protected boolean firstEatStalk = true;
	/** うまれて初めての食事か を取得する. @return うまれて初めての食事か */
	public boolean isFirstEatStalk() { return firstEatStalk; }
	/** うまれて初めての食事か を設定する. @param firstEatStalk うまれて初めての食事か */
	public void setFirstEatStalk(boolean firstEatStalk) { this.firstEatStalk = firstEatStalk; }
	/** 動けないかどうか */
	protected boolean lockmove = false;
	/** 動けないかどうか を取得する. @return 動けないかどうか */
	public boolean isLockmove() { return lockmove; }
	/** 動けないかどうか を設定する. @param lockmove 動けないかどうか */
	public void setLockmove(boolean lockmove) { this.lockmove = lockmove; }
	/** 動けない期間（押さえられてる等で） */
	protected int lockmovePeriod = 0;
	/** 動けない期間（押さえられてる等で） を取得する. @return 動けない期間（押さえられてる等で） */
	public int getLockmovePeriod() { return lockmovePeriod; }
	/** 動けない期間（押さえられてる等で） を設定する. @param lockmovePeriod 動けない期間（押さえられてる等で） */
	public void setLockmovePeriod(int lockmovePeriod) { this.lockmovePeriod = lockmovePeriod; }
	/** 喋れる状態かどうか */
	...
	public int[] getEatAmountBase() { return eatAmountBase; }
	/** 一回の食事量（年齢別） を設定する. @param eatAmountBase 一回の食事量（年齢別） */
	public void setEatAmountBase(int[] eatAmountBase) { this.eatAmountBase = eatAmountBase; }
	/** 体重（年齢別） */
	protected int[] weightBase = { 100, 300, 600 };
	/** 体重（年齢別） を取得する. @return 体重（年齢別） */
	public int[] getWeightBase() { return weightBase; }
	/** 体重（年齢別） を設定する. @param weightBase 体重（年齢別） */
	public void setWeightBase(int[] weightBase) { this.weightBase = weightBase; }
	/** 空腹限界（年齢別） */
	protected int[] hungryLimitBase = { 100 * 24, 100 * 24 * 2, 100 * 24 * 4 };
	/** 空腹限界（年齢別） を取得する. @return 空腹限界（年齢別） */
	public int[] getHungryLimitBase() { return hungryLimitBase; }
	/** 空腹限界（年齢別） を設定する. @param hungryLimitBase 空腹限界（年齢別） */
	public void setHungryLimitBase(int[] hungryLimitBase) { this.hungryLimitBase = hungryLimitBase; }
	/** うんうん限界（年齢別） */
	protected int[] shitLimitBase = { 100 * 12, 100 * 24, 100 * 24 };
	/** うんうん限界（年齢別） を取得する. @return うんうん限界（年齢別） */
	public int[] getShitLimitBase() { return shitLimitBase; }
	/** うんうん限界（年齢別） を設定する. @param shitLimitBase うんうん限界（年齢別） */
	public void setShitLimitBase(int[] shitLimitBase) { this.shitLimitBase = shitLimitBase; }
	/** ダメージ限界（年齢別） */
	protected int[] damageLimitBase = { 100 * 24, 100 * 24 * 3, 100 * 24 * 7 };
	/** ダメージ限界（年齢別） を取得する. @return ダメージ限界（年齢別） */
	public int[] getDamageLimitBase() { return damageLimitBase; }
	/** ダメージ限界（年齢別） を設定する. @param damageLimitBase ダメージ限界（年齢別） */
	public void setDamageLimitBase(int[] damageLimitBase) { this.damageLimitBase = damageLimitBase; }
	/** ストレス限界（年齢別） */
	protected int[] stressLimitBase = { 100 * 24, 100 * 24 * 3, 100 * 24 * 7 };
	/** ストレス限界（年齢別） を取得する. @return ストレス限界（年齢別） */
	public int[] getStressLimitBase() { return stressLimitBase; }
	/** ストレス限界（年齢別） を設定する. @param stressLimitBase ストレス限界（年齢別） */
	public void setStressLimitBase(int[] stressLimitBase) { this.stressLimitBase = stressLimitBase; }
	/** 味覚レベル（年齢別） */
	protected int[] tangLevelBase = { 300, 600, 1000 };
	/** 味覚レベル（年齢別） を取得する. @return 味覚レベル（年齢別） */
	public int[] getTangLevelBase() { return tangLevelBase; }
	/** 味覚レベル（年齢別） を設定する. @param tangLevelBase 味覚レベル（年齢別） */
	public void setTangLevelBase(int[] tangLevelBase) { this.tangLevelBase = tangLevelBase; }
	/** 足の速さ（年齢別） */
	protected int[] stepBase = { 1, 2, 4 };
	/** 足の速さ（年齢別） を取得する. @return 足の速さ（年齢別） */
	public int[] getStepBase() { return stepBase; }
	/** 足の速さ（年齢別） を設定する. @param stepBase 足の速さ（年齢別） */
	public void setStepBase(int[] stepBase) { this.stepBase = stepBase; }
	/** 攻撃力（年齢別） */
	...
	public void setStrengthBase(int[] strengthBase) { this.strengthBase = strengthBase; }
	/** 免疫力（年齢別、老ゆ含む） */
	...
	public void setImmunity(int[] immunity) { this.immunity = immunity; }
	/** ゲスポイントの下限 */
	protected int[] rudeLimit = { -100, -250 };
	/** ゲスポイントの下限 を取得する. @return ゲスポイントの下限 */
	public int[] getRudeLimit() { return rudeLimit; }
	/** ゲスポイントの下限 を設定する. @param rudeLimit ゲスポイントの下限 */
	public void setRudeLimit(int[] rudeLimit) { this.rudeLimit = rudeLimit; }
	/** 善良限界 */
	protected int[] niceLimit = { 100, 500 };
	/** 善良限界 を取得する. @return 善良限界 */
	public int[] getNiceLimit() { return niceLimit; }
	/** 善良限界 を設定する. @param niceLimit 善良限界 */
	public void setNiceLimit(int[] niceLimit) { this.niceLimit = niceLimit; }
	/** 自主洗浄失敗確率（賢い個体・年齢別） */
	protected int[] cleaningFailProbWise = { 10, 5, 2 };
	/** 自主洗浄失敗確率（賢い個体・年齢別） を取得する. @return 自主洗浄失敗確率（賢い個体・年齢別） */
	public int[] getCleaningFailProbWise() { return cleaningFailProbWise; }
	/** 自主洗浄失敗確率（賢い個体・年齢別） を設定する. @param cleaningFailProbWise 自主洗浄失敗確率（賢い個体・年齢別） */
	public void setCleaningFailProbWise(int[] cleaningFailProbWise) { this.cleaningFailProbWise = cleaningFailProbWise; }
	/** 自主洗浄失敗確率（普通個体・年齢別） */
	protected int[] cleaningFailProbAverage = { 25, 8, 3 };
	/** 自主洗浄失敗確率（普通個体・年齢別） を取得する. @return 自主洗浄失敗確率（普通個体・年齢別） */
	public int[] getCleaningFailProbAverage() { return cleaningFailProbAverage; }
	/** 自主洗浄失敗確率（普通個体・年齢別） を設定する. @param cleaningFailProbAverage 自主洗浄失敗確率（普通個体・年齢別） */
	public void setCleaningFailProbAverage(int[] cleaningFailProbAverage) { this.cleaningFailProbAverage = cleaningFailProbAverage; }
	/** 自主洗浄失敗確率（餡子脳個体・年齢別） */
	protected int[] cleaningFailProbFool = { 50, 10, 5 };
	/** 自主洗浄失敗確率（餡子脳個体・年齢別） を取得する. @return 自主洗浄失敗確率（餡子脳個体・年齢別） */
	public int[] getCleaningFailProbFool() { return cleaningFailProbFool; }
	/** 自主洗浄失敗確率（餡子脳個体・年齢別） を設定する. @param cleaningFailProbFool 自主洗浄失敗確率（餡子脳個体・年齢別） */
	public void setCleaningFailProbFool(int[] cleaningFailProbFool) { this.cleaningFailProbFool = cleaningFailProbFool; }
	// --- BodyTimingProfile fields ---
	/** 赤ゆ期間 */
	protected int babyLimitBase = 100 * 24 * 7;
	/** 赤ゆ期間 を取得する. @return 赤ゆ期間 */
	public int getBabyLimitBase() { return babyLimitBase; }
	/** 赤ゆ期間 を設定する. @param babyLimitBase 赤ゆ期間 */
	public void setBabyLimitBase(int babyLimitBase) { this.babyLimitBase = babyLimitBase; }
	/** 子ゆ期間 */
	protected int childLimitBase = 100 * 24 * 21;
	/** 子ゆ期間 を取得する. @return 子ゆ期間 */
	public int getChildLimitBase() { return childLimitBase; }
	/** 子ゆ期間 を設定する. @param childLimitBase 子ゆ期間 */
	public void setChildLimitBase(int childLimitBase) { this.childLimitBase = childLimitBase; }
	/** 寿命 */
	protected int lifeLimitBase = 100 * 24 * 365;
	/** 寿命 を取得する. @return 寿命 */
	public int getLifeLimitBase() { return lifeLimitBase; }
	/** 寿命 を設定する. @param lifeLimitBase 寿命 */
	public void setLifeLimitBase(int lifeLimitBase) { this.lifeLimitBase = lifeLimitBase; }
	/** 腐敗日数 */
	protected int rottingTimeBase = 100 * 24 * 3;
	/** 腐敗日数 を取得する. @return 腐敗日数 */
	public int getRottingTimeBase() { return rottingTimeBase; }
	/** 腐敗日数 を設定する. @param rottingTimeBase 腐敗日数 */
	public void setRottingTimeBase(int rottingTimeBase) { this.rottingTimeBase = rottingTimeBase; }
	/** リラックス状態の期間 */
	protected int relaxPeriodBase = 100 * 1;
	/** リラックス状態の期間 を取得する. @return リラックス状態の期間 */
	public int getRelaxPeriodBase() { return relaxPeriodBase; }
	/** リラックス状態の期間 を設定する. @param relaxPeriodBase リラックス状態の期間 */
	public void setRelaxPeriodBase(int relaxPeriodBase) { this.relaxPeriodBase = relaxPeriodBase; }
	/** 発情状態の期間 */
	protected int excitePeriodBase = 100 * 3;
	/** 発情状態の期間 を取得する. @return 発情状態の期間 */
	public int getExcitePeriodBase() { return excitePeriodBase; }
	/** 発情状態の期間 を設定する. @param excitePeriodBase 発情状態の期間 */
	public void setExcitePeriodBase(int excitePeriodBase) { this.excitePeriodBase = excitePeriodBase; }
	/** 妊娠期間 */
	protected int pregPeriodBase = 100 * 24;
	/** 妊娠期間 を取得する. @return 妊娠期間 */
	public int getPregPeriodBase() { return pregPeriodBase; }
	/** 妊娠期間 を設定する. @param pregPeriodBase 妊娠期間 */
	public void setPregPeriodBase(int pregPeriodBase) { this.pregPeriodBase = pregPeriodBase; }
	/** 睡眠時間 */
	protected int sleepPeriodBase = 100 * 3;
	/** 睡眠時間 を取得する. @return 睡眠時間 */
	public int getSleepPeriodBase() { return sleepPeriodBase; }
	/** 睡眠時間 を設定する. @param sleepPeriodBase 睡眠時間 */
	public void setSleepPeriodBase(int sleepPeriodBase) { this.sleepPeriodBase = sleepPeriodBase; }
	/** アクティブな期間 */
	protected int activePeriodBase = 100 * 6;
	/** アクティブな期間 を取得する. @return アクティブな期間 */
	public int getActivePeriodBase() { return activePeriodBase; }
	/** アクティブな期間 を設定する. @param activePeriodBase アクティブな期間 */
	public void setActivePeriodBase(int activePeriodBase) { this.activePeriodBase = activePeriodBase; }
	/** 怒り期間 */
	protected int angryPeriodBase = 100 * 1;
	/** 怒り期間 を取得する. @return 怒り期間 */
	public int getAngryPeriodBase() { return angryPeriodBase; }
	/** 怒り期間 を設定する. @param angryPeriodBase 怒り期間 */
	public void setAngryPeriodBase(int angryPeriodBase) { this.angryPeriodBase = angryPeriodBase; }
	/** 恐怖期間 */
	protected int scarePeriodBase = 100 * 1;
	/** 恐怖期間 を取得する. @return 恐怖期間 */
	public int getScarePeriodBase() { return scarePeriodBase; }
	/** 恐怖期間 を設定する. @param scarePeriodBase 恐怖期間 */
	public void setScarePeriodBase(int scarePeriodBase) { this.scarePeriodBase = scarePeriodBase; }
	/** 衝動抑制期間 */
	protected int declinePeriodBase = 20;
	/** 衝動抑制期間 を取得する. @return 衝動抑制期間 */
	public int getDeclinePeriodBase() { return declinePeriodBase; }
	/** 衝動抑制期間 を設定する. @param declinePeriodBase 衝動抑制期間 */
	public void setDeclinePeriodBase(int declinePeriodBase) { this.declinePeriodBase = declinePeriodBase; }
	/** 壁等にブロックされた回数の限界 */
	protected int blockedLimitBase = 60;
	/** 壁等にブロックされた回数の限界 を取得する. @return 壁等にブロックされた回数の限界 */
	public int getBlockedLimitBase() { return blockedLimitBase; }
	/** 壁等にブロックされた回数の限界 を設定する. @param blockedLimitBase 壁等にブロックされた回数の限界 */
	public void setBlockedLimitBase(int blockedLimitBase) { this.blockedLimitBase = blockedLimitBase; }
	/** 汚れ限界（超えるとゆかび状態） */
	protected int dirtyPeriodBase = 300;
	/** 汚れ限界（超えるとゆかび状態） を取得する. @return 汚れ限界（超えるとゆかび状態） */
	public int getDirtyPeriodBase() { return dirtyPeriodBase; }
	/** 汚れ限界（超えるとゆかび状態） を設定する. @param dirtyPeriodBase 汚れ限界（超えるとゆかび状態） */
	public void setDirtyPeriodBase(int dirtyPeriodBase) { this.dirtyPeriodBase = dirtyPeriodBase; }
	/** 視界の広さ（二乗距離） */
	protected int eyesightBase = 4000 * 4000;
	/** 視界の広さ（二乗距離） を取得する. @return 視界の広さ（二乗距離） */
	public int getEyesightBase() { return eyesightBase; }
	/** 視界の広さ（二乗距離） を設定する. @param eyesightBase 視界の広さ（二乗距離） */
	public void setEyesightBase(int eyesightBase) { this.eyesightBase = eyesightBase; }
	/** ゆかびの潜伏期間 */
	protected int incubationPeriodBase = 100 * 12;
	/** ゆかびの潜伏期間 を取得する. @return ゆかびの潜伏期間 */
	public int getIncubationPeriodBase() { return incubationPeriodBase; }
	/** ゆかびの潜伏期間 を設定する. @param incubationPeriodBase ゆかびの潜伏期間 */
	public void setIncubationPeriodBase(int incubationPeriodBase) { this.incubationPeriodBase = incubationPeriodBase; }
	// --- BodyBehaviorProfile fields ---
	/** なつき度限界 */
	protected int lovePlayerLimitBase = 1000;
	/** なつき度限界 を取得する. @return なつき度限界 */
	public int getLovePlayerLimitBase() { return lovePlayerLimitBase; }
	/** なつき度限界 を設定する. @param lovePlayerLimitBase なつき度限界 */
	public void setLovePlayerLimitBase(int lovePlayerLimitBase) { this.lovePlayerLimitBase = lovePlayerLimitBase; }
	/** おさげ破壊確率 */
	protected int braidBreakChance = 0;
	/** おさげ破壊確率 を取得する. @return おさげ破壊確率 */
	public int getBraidBreakChance() { return braidBreakChance; }
	/** おさげ破壊確率 を設定する. @param braidBreakChance おさげ破壊確率 */
	public void setBraidBreakChance(int braidBreakChance) { this.braidBreakChance = braidBreakChance; }
	/** すりすり事故妊娠確率（N回に1回） */
	protected int surisuriAccidentProb = 200;
	/** すりすり事故妊娠確率（N回に1回） を取得する. @return すりすり事故妊娠確率（N回に1回） */
	public int getSurisuriAccidentProb() { return surisuriAccidentProb; }
	/** すりすり事故妊娠確率（N回に1回） を設定する. @param surisuriAccidentProb すりすり事故妊娠確率（N回に1回） */
	public void setSurisuriAccidentProb(int surisuriAccidentProb) { this.surisuriAccidentProb = surisuriAccidentProb; }
	/** 車轢き確率（N回に1回） */
	protected int carAccidentProb = 10000;
	/** 車轢き確率（N回に1回） を取得する. @return 車轢き確率（N回に1回） */
	public int getCarAccidentProb() { return carAccidentProb; }
	/** 車轢き確率（N回に1回） を設定する. @param carAccidentProb 車轢き確率（N回に1回） */
	public void setCarAccidentProb(int carAccidentProb) { this.carAccidentProb = carAccidentProb; }
	/** うんうんによるあんよ破壊確率（N回に1回） */
	protected int breakBodyByShitProb = 100;
	/** うんうんによるあんよ破壊確率（N回に1回） を取得する. @return うんうんによるあんよ破壊確率（N回に1回） */
	public int getBreakBodyByShitProb() { return breakBodyByShitProb; }
	/** うんうんによるあんよ破壊確率（N回に1回） を設定する. @param breakBodyByShitProb うんうんによるあんよ破壊確率（N回に1回） */
	public void setBreakBodyByShitProb(int breakBodyByShitProb) { this.breakBodyByShitProb = breakBodyByShitProb; }
	/** 苦いフードでゆ下痢になる確率（N回に1回） */
	protected int diarrheaProb = 5;
	/** 苦いフードでゆ下痢になる確率（N回に1回） を取得する. @return 苦いフードでゆ下痢になる確率（N回に1回） */
	public int getDiarrheaProb() { return diarrheaProb; }
	/** 苦いフードでゆ下痢になる確率（N回に1回） を設定する. @param diarrheaProb 苦いフードでゆ下痢になる確率（N回に1回） */
	public void setDiarrheaProb(int diarrheaProb) { this.diarrheaProb = diarrheaProb; }
	/** 発情確率（N回に1回） */
	protected int exciteProb = 1;
	/** 発情確率（N回に1回） を取得する. @return 発情確率（N回に1回） */
	public int getExciteProb() { return exciteProb; }
	/** 発情確率（N回に1回） を設定する. @param exciteProb 発情確率（N回に1回） */
	public void setExciteProb(int exciteProb) { this.exciteProb = exciteProb; }
	/** 性格変化の切り替え */
	protected boolean notChangeCharacter = false;
	/** 性格変化の切り替え を取得する. @return 性格変化の切り替え */
	public boolean isNotChangeCharacter() { return notChangeCharacter; }
	/** 性格変化の切り替え を設定する. @param notChangeCharacter 性格変化の切り替え */
	public void setNotChangeCharacter(boolean notChangeCharacter) { this.notChangeCharacter = notChangeCharacter; }
	/** ゲスポイント */
	protected int attitudePoint = 0;
	/** ゲスポイント を取得する. @return ゲスポイント */
	public int getAttitudePoint() { return attitudePoint; }
	/** ゲスポイント を設定する. @param attitudePoint ゲスポイント */
	public void setAttitudePoint(int attitudePoint) { this.attitudePoint = attitudePoint; }
	/** 同一方向移動継続係数 */
	protected int sameDirectionFactor = 30;
	/** 同一方向移動継続係数 を取得する. @return 同一方向移動継続係数 */
	public int getSameDirectionFactor() { return sameDirectionFactor; }
	/** 同一方向移動継続係数 を設定する. @param sameDirectionFactor 同一方向移動継続係数 */
	public void setSameDirectionFactor(int sameDirectionFactor) { this.sameDirectionFactor = sameDirectionFactor; }
	/** 固有の免疫力（個体値） */
	protected int immunityStrength = 1;
	/** 固有の免疫力（個体値） を取得する. @return 固有の免疫力（個体値） */
	public int getImmunityStrength() { return immunityStrength; }
	/** 固有の免疫力（個体値） を設定する. @param immunityStrength 固有の免疫力（個体値） */
	public void setImmunityStrength(int immunityStrength) { this.immunityStrength = immunityStrength; }
	/** 妊娠限界 */
	protected int pregnantLimit = 1000;
	/** 妊娠限界 を取得する. @return 妊娠限界 */
	public int getPregnantLimit() { return pregnantLimit; }
	/** 妊娠限界 を設定する. @param pregnantLimit 妊娠限界 */
	public void setPregnantLimit(int pregnantLimit) { this.pregnantLimit = pregnantLimit; }
	/** よりリアルな妊娠限界を使用するか */
	protected boolean useRealPregnantLimit = true;
	/** よりリアルな妊娠限界を使用するか を取得する. @return よりリアルな妊娠限界を使用するか */
	public boolean isUseRealPregnantLimit() { return useRealPregnantLimit; }
	/** よりリアルな妊娠限界を使用するか を設定する. @param useRealPregnantLimit よりリアルな妊娠限界を使用するか */
	public void setUseRealPregnantLimit(boolean useRealPregnantLimit) { this.useRealPregnantLimit = useRealPregnantLimit; }
	// --- BodySpriteSet fields ---
	/** 本体のスプライト定義（年齢別） */
	protected Sprite[] bodySpr = new Sprite[3];
	/** 本体のスプライト定義（年齢別） を取得する. @return 本体のスプライト定義（年齢別） */
	public Sprite[] getBodySpr() { return bodySpr; }
	/** 本体のスプライト定義（年齢別） を設定する. @param bodySpr 本体のスプライト定義（年齢別） */
	public void setBodySpr(Sprite[] bodySpr) { this.bodySpr = bodySpr; }
	/** 拡幅分のスプライト定義（年齢別） */
	protected Sprite[] expandSpr = new Sprite[3];
	/** 拡幅分のスプライト定義（年齢別） を取得する. @return 拡幅分のスプライト定義（年齢別） */
	public Sprite[] getExpandSpr() { return expandSpr; }
	/** 拡幅分のスプライト定義（年齢別） を設定する. @param expandSpr 拡幅分のスプライト定義（年齢別） */
	public void setExpandSpr(Sprite[] expandSpr) { this.expandSpr = expandSpr; }
	/** おさげのスプライト定義（年齢別） */
	protected Sprite[] braidSpr = new Sprite[3];
	/** おさげのスプライト定義（年齢別） を取得する. @return おさげのスプライト定義（年齢別） */
	public Sprite[] getBraidSpr() { return braidSpr; }
	/** おさげのスプライト定義（年齢別） を設定する. @param braidSpr おさげのスプライト定義（年齢別） */
	public void setBraidSpr(Sprite[] braidSpr) { this.braidSpr = braidSpr; }
	...
	public void copyStateTo(Entity to) {
		...
		// --- 基本状態 ---
		l.setDamage(damage); l.setDamageState(damageState);
		l.setStress(stress); l.setHungry(hungry); l.setShit(shit); l.setTang(tang);
		l.setDead(dead); l.setDeadPeriod(deadPeriod);
		l.setCoreAnkoState(coreAnkoState);
		l.setSleeping(sleeping); l.setNightmare(nightmare); l.setWakeUpTime(wakeUpTime);
		l.setExciting(exciting); l.setForceExciting(forceExciting); l.setRelax(relax);
		l.setDirty(dirty); l.setStubbornlyDirty(stubbornlyDirty);
		l.setDirtyPeriod(dirtyPeriod); l.setDirtyScreamPeriod(dirtyScreamPeriod);
		l.setWet(wet); l.setWetPeriod(wetPeriod); l.setMelt(melt);
		l.setPealed(pealed); l.setPacked(packed); l.setBlind(blind);
		l.setNeedled(needled); l.setBurned(burned); l.setCrushed(crushed);
		l.setPheromone(pheromone); l.setHasBraid(hasBraid); l.setBraidType(braidType);
		l.setHasPants(hasPants); l.setAnalClose(analClose);
		l.setBodyCastration(bodyCastration); l.setStalkCastration(stalkCastration);
		l.setPenipeniCutted(penipeniCutted); l.setHairState(hairState);
		l.setFlyingType(flyingType); l.setRareType(rareType); l.setPredatorType(predatorType);
		l.setLikeBitterFood(likeBitterFood); l.setLikeHotFood(likeHotFood); l.setLikeWater(likeWater);
		l.setBirth(birth); l.setBirthAge(birthAge); l.setUnBirth(unBirth);
		l.setPregnantPeriod(pregnantPeriod); l.setPanicType(panicType); l.setPanicPeriod(panicPeriod);
		l.setCriticalDamege(criticalDamege); l.setTrauma(trauma);
		l.setNoDamagePeriod(noDamagePeriod); l.setNoHungryPeriod(noHungryPeriod);
		l.setSuperEatingNoHungryPeriod(superEatingNoHungryPeriod);
		l.setFootBakePeriod(footBakePeriod); l.setBodyBakePeriod(bodyBakePeriod);
		l.setNonYukkuriDiseasePeriod(nonYukkuriDiseasePeriod);
		l.setAngryPeriod(angryPeriod); l.setScarePeriod(scarePeriod); l.setSadPeriod(sadPeriod);
		l.setExcitingPeriod(excitingPeriod); l.setSleepingPeriod(sleepingPeriod); l.setSickPeriod(sickPeriod);
		l.setFalldownDamage(falldownDamage); l.setNoDamageNextFall(noDamageNextFall);
		l.setCantDiePeriod(cantDiePeriod); l.setBurialState(burialState);
		// --- インベントリ ---
		l.setOkazari(okazari); l.setOkazariPosition(okazariPosition);
		l.setHasBaby(hasBaby); l.setHasStalk(hasStalk);
		...
		// --- 移動・アクション状態 ---
		l.setDestX(destX); l.setDestY(destY); l.setDestZ(destZ);
		l.setCountX(countX); l.setCountY(countY); l.setCountZ(countZ);
		l.setDirX(dirX); l.setDirY(dirY); l.setDirZ(dirZ);
		l.setDirection(direction); l.setPurposeOfMoving(purposeOfMoving);
		l.setCanPullOrPush(canPullOrPush); l.setExternalPressure(externalPressure);
		l.setMoveTargetId(moveTargetId); l.setTargetOffsetX(targetOffsetX); l.setTargetOffsetY(targetOffsetY);
		l.setShitting(shitting); l.setEating(eating); l.setEatingShit(eatingShit); l.setSukkiri(sukkiri);
		l.setScare(scare); l.setAngry(angry); l.setFurifuri(furifuri); l.setStrike(strike);
		l.setNobinobi(nobinobi); l.setBeVain(beVain); l.setPikopiko(pikopiko);
		l.setPurupuru(purupuru); l.setYunnyaa(yunnyaa);
		l.setSilent(silent); l.setShutmouth(shutmouth); l.setBegging(begging);
		l.setPlaying(playing); l.setPlayingLimit(playingLimit);
		l.setShakePhase(shakePhase); l.setFixBack(fixBack);
		l.setStaying(staying); l.setStayTicks(stayTicks); l.setStayTime(stayTime);
		l.setMessageBuffer(messageBuffer); l.setMessageTicks(messageTicks);
		l.setMessageLineColor(messageLineColor); l.setMessageBoxColor(messageBoxColor);
		l.setMessageTextColor(messageTextColor); l.setMessageWindowStroke(messageWindowStroke);
		l.setMessageTextSize(messageTextSize); l.setBirthMessageForced(birthMessageForced);
		l.setShadowVisible(shadowVisible); l.setImageNagasiMode(imageNagasiMode);
		l.setBlinkCount(blinkCount); l.setBlinkType(blinkType);
		l.setUnyoMode(unyoMode); l.setUnyoOffsetH(unyoOffsetH); l.setUnyoOffsetW(unyoOffsetW);
		l.setEventList(eventList != null ? new LinkedList<>(eventList) : null);
		l.setCurrentEvent(currentEvent); l.setEventResult(eventResult);
		// --- ID・識別 ---
		l.setUniqueID(uniqueID); l.setMsgType(msgType); l.setShitType(shitType);
		// --- その他状態 ---
		l.setTaken(taken); l.setIsPinned(isPinned);
		l.setSurisuriFromPlayer(surisuriFromPlayer); l.setLastSurisuriTime(lastSurisuriTime);
		l.setInOutTakeoutItem(inOutTakeoutItem);
		l.setAbFlagGodHand(abFlagGodHand != null ? abFlagGodHand.clone() : null);
		l.setGodHandHoldCount(godHandHoldCount); l.setGodHandStretchCount(godHandStretchCount);
		l.setGodHandCompressCount(godHandCompressCount);
		l.setAntCount(antCount); l.setNonMovingConveyor(nonMovingConveyor);
		l.setLastActionTime(lastActionTime); l.setBlockedTicks(blockedTicks);
		l.setPregnancyPeriodBoost(pregnancyPeriodBoost); l.setExcitementPeriodBoost(excitementPeriodBoost);
		l.setExcretionBoost(excretionBoost);
		l.setFirstGround(firstGround); l.setFirstEatStalk(firstEatStalk);
		l.setLockmove(lockmove); l.setLockmovePeriod(lockmovePeriod); l.setCanTalk(canTalk);
		// --- 個体値 ---
		l.setAttitudePoint(attitudePoint); l.setImmunityStrength(immunityStrength);
		...
		l.setBabyLimitBase(babyLimitBase); l.setChildLimitBase(childLimitBase);
		l.setLifeLimitBase(lifeLimitBase); l.setRottingTimeBase(rottingTimeBase);
		l.setRelaxPeriodBase(relaxPeriodBase); l.setExcitePeriodBase(excitePeriodBase);
		l.setPregPeriodBase(pregPeriodBase); l.setSleepPeriodBase(sleepPeriodBase);
		l.setActivePeriodBase(activePeriodBase); l.setAngryPeriodBase(angryPeriodBase);
		l.setScarePeriodBase(scarePeriodBase); l.setDeclinePeriodBase(declinePeriodBase);
		l.setBlockedLimitBase(blockedLimitBase); l.setDirtyPeriodBase(dirtyPeriodBase);
		l.setEyesightBase(eyesightBase); l.setIncubationPeriodBase(incubationPeriodBase);
		l.setLovePlayerLimitBase(lovePlayerLimitBase); l.setBraidBreakChance(braidBreakChance);
		l.setSurisuriAccidentProb(surisuriAccidentProb); l.setCarAccidentProb(carAccidentProb);
		l.setBreakBodyByShitProb(breakBodyByShitProb); l.setDiarrheaProb(diarrheaProb);
		l.setExciteProb(exciteProb); l.setNotChangeCharacter(notChangeCharacter);
		l.setSameDirectionFactor(sameDirectionFactor);
		l.setPregnantLimit(pregnantLimit); l.setUseRealPregnantLimit(useRealPregnantLimit);
		l.setSpeed(speed);
	}
