 ...
 * ぱちゅりー
 */
public class Patch extends Yukkuri {
	private static final long serialVersionUID = -2595750636519959977L;
	/** ぱちゅりーのタイプ */
	public static final YukkuriType type = YukkuriType.PATCH;
	/** ぱちゅりー和名 */
	...
	/** コンストラクタ */
	public Patch(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
