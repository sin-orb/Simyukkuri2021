...
public class VeryShitAmpoule extends Attachment {
	...
	public static void loadImages(ClassLoader loader, ImageObserver io) throws IOException {
		...
		images[adult][0] = ModLoader.loadItemImage(loader, "ampoule" + File.separator + "veryshit.png");
	...
	/** うんうんアンプルのティック処理。ちぎれていなければうんうん量を最高にして排便を誘発する。 */
	@Override
	 ...
	 */
	public VeryShitAmpoule(Yukkuri body) {
		super(body);
