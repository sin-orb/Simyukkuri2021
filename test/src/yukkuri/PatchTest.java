...
public class PatchTest {
    ...
    public void testLoadImages_headless_executesCode() {
        try {
            ...
            java.lang.reflect.Field fl = Patch.class.getDeclaredField("imageLoaded");
            fl.setAccessible(true);
            boolean oldVal = fl.getBoolean(null);
            fl.setBoolean(null, true);
            Patch.loadImages(Patch.class.getClassLoader(), null);
    ...
    public void testGetImage_executesCode() {
        try {
            ...
            java.lang.reflect.Field fp = Patch.class.getDeclaredField("imagePack");
    ...
    public void testLoadIniFile_executesCode() {
        try {
            Patch.loadIniFile(Patch.class.getClassLoader());
        } catch (Exception e) { } finally {
            try {
                java.lang.reflect.Field fa = Patch.class.getDeclaredField("AttachOffset");
