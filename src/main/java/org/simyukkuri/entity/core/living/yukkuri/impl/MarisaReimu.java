 ...
 * 設定的にはよくわからない…
 */
public class MarisaReimu extends Reimu {
	private static final long serialVersionUID = 5752287241118591422L;
	/** まりされいむのタイプ */
	public static final YukkuriType type = YukkuriType.MARISAREIMU;
	/** まりされいむ和名 */
	...
	/** コンストラクタ */
	public MarisaReimu(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
