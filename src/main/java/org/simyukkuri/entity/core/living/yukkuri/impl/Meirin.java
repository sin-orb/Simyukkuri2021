...
public class Meirin extends Yukkuri {
	...
	/** めーりんのタイプ */
	public static final YukkuriType type = YukkuriType.MEIRIN;
	/** めーりん和名 */
	public static final String nameJ = "めーりん";
	/** めーりん英名 */
	public static final String nameE = "Merin";
	/** めーりんベースファイル名 */
	public static final String baseFileName = "merin";
	...
	public Meirin(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
		...
		setShitType(YukkuriType.MEIRIN);
		setBaseYukkuriFileName(baseFileName);
		IniFileUtil.readYukkuriIniFile(this);
	}

	/** めいりん（従者種） のデフォルトコンストラクタ。 */
	public Meirin() {
