...
public final class BodyParentRule {
	...
	public static void checkNearParent(Yukkuri body) {
		...
		Yukkuri parentBody = org.simyukkuri.util.BodyRegistry.getBodyInstance(body.getMother());
		if (parentBody == null) {
			parentBody = org.simyukkuri.util.BodyRegistry.getBodyInstance(body.getFather());
		}
		if (parentBody == null) {
