...
public class MarisaTsumuri extends Marisa {
	...
	/** まりさつむりのタイプ */
	public static final YukkuriType type = YukkuriType.MARISATSUMURI;
	/** まりさつむり和名 */
	...
	/** コンストラクタ */
	public MarisaTsumuri(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
