...
import org.simyukkuri.logic.BodyRenderState;
...
public final class YukkuriSprite {
	...
	public void setBoundary(Dimension4y[] bodyBoundary, Dimension4y[] braidBoundary) {
		...
		for (int i = 0; i < bodyLen; i++) {
			...
			body.getBodySpr()[i] = new org.simyukkuri.system.Sprite(w, h, org.simyukkuri.system.Sprite.PIVOT_CENTER_BOTTOM);
	 ...
	 * @return 胴体スプライト
	 */
	public org.simyukkuri.system.Sprite getBodyBaseSpr() {
	 ...
	 * @return 拡張スプライト
	 */
	public org.simyukkuri.system.Sprite getBodyExpandSpr() {
