...
public class MyonTest {
    ...
    public void testLoadImages_headless_executesCode() {
        try {
            ...
            java.lang.reflect.Field fl = Myon.class.getDeclaredField("imageLoaded");
            fl.setAccessible(true);
            boolean oldVal = fl.getBoolean(null);
            fl.setBoolean(null, true);
            Myon.loadImages(Myon.class.getClassLoader(), null);
    ...
    public void testGetImage_executesCode() {
        try {
            ...
            java.lang.reflect.Field fp = Myon.class.getDeclaredField("imagePack");
    ...
    public void testLoadIniFile_executesCode() {
        try {
            Myon.loadIniFile(Myon.class.getClassLoader());
        } catch (Exception e) { } finally {
            try {
                java.lang.reflect.Field fa = Myon.class.getDeclaredField("AttachOffset");
