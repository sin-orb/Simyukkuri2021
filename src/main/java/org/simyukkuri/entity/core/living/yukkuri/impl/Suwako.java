 ...
 * すわこ
 */
public class Suwako extends Yukkuri {
	private static final long serialVersionUID = -4064518153559524056L;
	/** すわこのタイプ */
	public static final YukkuriType type = YukkuriType.SUWAKO;
	/** すわこの和名 */
	public static final String nameJ = "すわこ";
	/** すわこの英名 */
	public static final String nameE = "Suwako";
	/** すわこベースファイル名 */
	public static final String baseFileName = "suwako";
	...
	/** コンストラクタ */
	public Suwako(int initX, int initY, int initZ, AgeState initAgeState, Yukkuri p1, Yukkuri p2) {
		super(initX, initY, initZ, initAgeState, p1, p2);
		setBoundary(boundary, braidBoundary);
		setMsgType(YukkuriType.SUWAKO);
		setShitType(YukkuriType.SUWAKO);
